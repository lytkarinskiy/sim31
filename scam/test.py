...
crc_um_rtu = crcmod.mkCrcFun(poly=0x18005, initCrc=0xBF40)
crc_um_gsm = crcmod.predefined.mkPredefinedCrcFun('modbus')

text = "00000000,RDIAGN"

cmd_gsm = (text+format(crc_um_gsm(text.encode('utf-8')), "x")+'\0xA\0xA').encode('utf-8')
cmd_gsm
cmd_rtu = (text+format(crc_um_rtu(text.encode('utf-8')), "x")+'\0xA\0xA').encode('utf-8')
cmd_rtu
cmd_cus = (text+format(custom_crc(text.encode('utf-8')), "x")+'\0xA\0xA').encode('utf-8')
cmd_cus
